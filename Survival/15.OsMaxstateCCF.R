...
#-----------------------------------------------------
## 读入每个基因打上CCF值标签的临床数据
load("D:/Rsources/Project/预后分析/克隆预后分析/结直肠癌克隆预后分析/Results/3.SurvivalKM/CRC.clinical.CCF.data.list.RData")
...
## 单因素maxstat
{
  ...
  save(mtHL.res,file="D:/Rsources/Project/预后分析/克隆预后分析/结直肠癌克隆预后分析/Results/3.SurvivalKM/CRC.OS.ccf.maxstat.res.list.RData")
  load(file="D:/Rsources/Project/预后分析/克隆预后分析/结直肠癌克隆预后分析/Results/3.SurvivalKM/CRC.OS.ccf.maxstat.res.list.RData")
